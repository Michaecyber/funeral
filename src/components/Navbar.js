      ...
      <nav className="flex h-9 items-center justify-between" aria-label="Global">
        <div className="flex lg:min-w-0 lg:flex-1" aria-label="Global">
          <a href="#" className="-m-1.5 p-1.5">
            <span className="sr-only text-lime-400">Today's Hope Funeral Service</span>
        ...
        <div className='flex'>
          ...
          <div className="hidden lg:flex lg:min-w-0 lg:flex-1 lg:gap-x-1">
            ...
            <Link to="home" spy={true} smooth={true} offset={50} duration={500} className="font-semibold text-gray-900 hover:text-gray-900 hover:bg-zinc-200 py-2 px-4 rounded-md cursor-pointer">Contact-Us</Link>
          </div>
      ...
      <div className={sideNav ? ' ease-in-out duration-100' : 'hidden'}>
        <div focus="true" className="fixed inset-0 z-10 overflow-y-auto bg-white p-4 ">
          <div className="flex h-9 items-center justify-between">
            <div className="flex">
              <h2 className='inline-block rounded-lg  py-2 text-4xl leading-6 text-lime-500 font-extrabold '>Today's Hope Funeral Service</h2>
            </div>
            <div className="flex">
              <button type="button" onClick={handleNav} className="-m-2.5 inline-flex items-center justify-center rounded-md p-2.5 text-gray-700">
